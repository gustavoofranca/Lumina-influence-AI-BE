...
| O front-end tem verificação automatizada no servidor | build a cada push, com portão que **reprova de fato** — conferido quebrando um import; lint com 16 erros visíveis, ainda sem reprovar | ESLint 9 configurado em 09/09 sobre 173 arquivos; primeira execução com 25 erros, 9 corrigidos | `FE/.github/workflows/ci.yml` |
