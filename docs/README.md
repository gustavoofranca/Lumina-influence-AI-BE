...
- **Suíte do back-end em 01/09, após a frente de robustez:** 416 testes, 95%
- **Suíte de interface:** 68 testes ponta a ponta em Playwright
...
| 13 | Ações que a interface oferecia e não aconteciam | 1 mentira de interface e 3 endpoints prontos sem caminho na tela | [`acoes-que-nao-aconteciam.md`](acoes-que-nao-aconteciam.md) |
