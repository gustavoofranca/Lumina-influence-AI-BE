...
- **Suíte do back-end em 31/08, após a frente de robustez:** 374 testes, 95%
- **Suíte de interface:** 44 testes ponta a ponta em Playwright
...
| 10 | Testes ponta a ponta da interface | 44 testes em Playwright cobrindo rotas, login, estado de erro, conta social, relatório, tema, idioma, foco, páginas legais e exclusão de criador | [`testes/e2e-front.md`](testes/e2e-front.md) |
