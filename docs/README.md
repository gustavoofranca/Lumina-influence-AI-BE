...
- **Suíte de interface:** 30 testes ponta a ponta em Playwright
...
| 10 | Testes ponta a ponta da interface | 30 testes em Playwright cobrindo rotas, login, estado de erro, conta social, relatório, tema e idioma | [`testes/e2e-front.md`](testes/e2e-front.md) |
